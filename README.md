...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/young-paper-e7ee)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/young-paper-e7ee
```

A live public deployment of this template is available at [https://young-paper-e7ee.templates.workers.dev](https://young-paper-e7ee.templates.workers.dev)
